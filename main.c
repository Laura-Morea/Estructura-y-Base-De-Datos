...
#include <stdlib.h>
#include <string.h>
// Dimensiones de la tabla de traducción Morse
#define FILAS_MORSE 37 // Incluye letras (26) + números (10) + terminador NULL o sea 37
...
int error(char *);
void pausa(void);
// Tabla de traducción Morse a ASCII ( esta tabla que es una simple matriz estructurada, tienen todo para que
...
int main()
{
    ...
    {
        // Eliminar el salto de línea ya que del archivo trae el barra n
